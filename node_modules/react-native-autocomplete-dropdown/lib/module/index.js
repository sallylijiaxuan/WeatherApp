...
export const AutocompleteDropdown = /*#__PURE__*/memo( /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const renderItem = useCallback(({
    ...
    return /*#__PURE__*/React.createElement(ScrollViewListItem, {
      key: item.id,
      title: item.title || '',
  ...
  const ListEmptyComponent = useMemo(() => {
    return EmptyResultComponent ?? /*#__PURE__*/React.createElement(NothingFound, {
  ...
  useEffect(() => {
    if (isOpened && Array.isArray(dataSet)) {
      ...
      setContent( /*#__PURE__*/React.createElement(Dropdown, _extends({}, props, {
        direction,
        inputHeight,
        dataSet,
  ...
  }, LeftComponent, /*#__PURE__*/React.createElement(Pressable, {
